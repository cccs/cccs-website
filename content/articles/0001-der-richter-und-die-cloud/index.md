...
Facebook ist in Deutschland mit einer GmbH vertreten, die in Hamburg ansässig ist. An diese richtete Hamann zunächst seinen Richterbeschluss. Anstatt einer promten Antwort erhielt er nur ein (vermutlich automatisiertes) Schreiben einer „Jana“, dass seiner Anfrage eine „Record Number“ zugeteilt worden wäre. Erst auf hartnäckiges Nachhaken hin versichterte Facebook Hamburg an Eides Statt per Brief, dass es in Deutschland keine Person gäbe, die Zugriff auf diese Art von Daten habe, da die Facebook GmbH in Deutschland nur für Marketing zuständig sei.
